...
// Only purchase info is editable after a card's been added — everything else
// (identity, valuation, images) comes from the scan flow. Keeping the patch
// surface narrow avoids this becoming a way to silently rewrite the card's
